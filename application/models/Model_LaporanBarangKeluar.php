<?php
class Model_LaporanBarangKeluar extends CI_Model
{
	var $table = 'request';
	...
	private function _get_datatables_query()
	{
		...
		$this->db->join("request","rq_id = rqd_rq_id", "left");
		$this->db->join("barang","brg_id = rqd_brg_id", "left");
		$this->db->join("project","id_project = id_prj", "left");
		$this->db->where('rqd_status', 1);
