	...
	<div class="row">
		...
		<div class="col-md-2 col-xs-12">
			<div class="form-group">
				<a href="<?= base_url("LaporanBarangKeluar/cetak")?>"  class="btn btn-dark btn-block"><i class="fa fa-print"></i> &nbsp;&nbsp;&nbsp; Cetak</a>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body table-responsive">
					<table class="table table-striped table-bordered table-hover" id="tabel-laporanbarangkeluar" width="100%" style="font-size:120%;">
						<thead>
							<tr>
								<th>No</th>
								<th>Nama Barang</th>
...
<script>
	...
	function drawTable() {
		$('#tabel-laporanbarangkeluar').DataTable({
			"destroy": true,
			dom: 'Bfrtip',
			lengthMenu: [
				[10, 25, 50, -1],
			...
			"ajax": {
				"url": "ajax_list_laporanbarangkeluar/",
				"type": "POST"
			},
	...
	// 	gdg = $("#id_gudang").val();
	// 	window.open("<?= base_url('laporanbarangkeluar/cetak_stok/') ?>"+gdg, "_blank");
	// }
