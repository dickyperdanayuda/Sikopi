		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body table-responsive">
					<table class="table table-striped table-bordered table-hover" id="tabel-gudang" width="100%" style="font-size:120%;">
						<thead>
							<tr>
								<th>No</th>
								<th>Nama Gudang</th>
...
<!-- Bootstrap modal -->
<div class="modal fade" id="modal_gudang" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title"><i class="glyphicon glyphicon-info"></i> Form Gudang</h3>
			</div>
			<form role="form  col-lg-6" name="Barang" id="frm_gudang">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="alamat_gudang" id="alamat_gudang" placeholder="" required>
							</div>
						</div>
