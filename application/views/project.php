						...
						<div class="col-lg-12">
							<div id="inputFormRow">
                        		<div class="input-group mb-3">
	                           		<!-- <input type="text"  class="form-control m-input" placeholder="Enter title" autocomplete="off"> -->

	                           		<select class="form-control select2" style="width:100%" multiple="multiple" name="dp_id_gudang[]" id="dp_id_gudang" required>
	...
	function ubah_project(id) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				if (dt[0] == "dp_id_gudang") {
					split_text = dt[1].split(",");
					// console.log(split_text);
					$("#dp_id_gudang").val(split_text).change();
				}else if(dt[0] == "tgl_project"){
					if (dt[1] != null) {
						var tgl = dt[1].split("-");
