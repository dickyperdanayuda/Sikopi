...
<style>
	...
	<div id="cetakFaktur">
		<table border="0" width="100%">
			<tr>
				<td colspan="2" valign="middle" align="center" style="vertical-align:middle;text-transform:uppercase;font-size:24px;">Laporan Stok </td>
			</tr>
		</table>
