					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select class="form-control select" name="stk_id_brg" id="stk_id_brg" required>
										<option value="">== Pilih ==</option>
										<?php foreach ($barang as $brg) {
										?>
											<option value="<?= $brg->brg_id; ?>"><?= "{$brg->brg_nama}"; ?></option>
										<?php } ?>
								</select>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>Jumlah</label>
								<input type="number" class="form-control" name="stk_jml" id="stk_jml" required>
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<select class="form-control" name="stk_kategori" id="stk_kategori">
									<option value="">== Pilih ==</option>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label>Project</label>
								<select class="form-control select" name="stk_id_prj" id="stk_id_prj">
										<option value="">== Pilih ==</option>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label>Gudang</label>
								<select class="form-control select" name="stk_id_gudang" id="stk_id_gudang">
										<option value="">== Pilih ==</option>
