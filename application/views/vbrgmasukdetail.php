<?php
$total = 0;
if (!empty($list_brgmasukdetail)) {
	$data = explode("-", $list_brgmasukdetail);
	$max = count($data);
	...
	if ($max > 0) {
		for ($i = 1; $i < $max; $i++) { ?>
			<tr>
				...
				?>
				<td><a href="javascript:void()" onClick="hapusBarangMasukDetail('<?= $data[$i]; ?>')" class="btn btn-danger btn-circle"><i class="fa fa-times" /></a></td>
			</tr>
<?php
		}
	}
...
<tr>
	<td colspan="7" align="center"><a href="#" onClick="inputBarangMasukDetail()" class="btn btn-success"><i class="fa fa-plus"></i> &nbsp;&nbsp;&nbsp; Tambah Detail Barang Masuk</a></td>
</tr>
<script>
