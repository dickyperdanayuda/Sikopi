...
<style>
	...
	<div id="cetakFaktur">
		<table border="0" width="100%">
			<tr>
				<td colspan="2" valign="middle" align="center" style="vertical-align:middle;text-transform:uppercase;font-size:24px;">Laporan Barang Masuk </td>
			</tr>
		</table>
		<table width="100%" style="margin-top:20px;font-size:12px;" border="1" cellpadding="0" cellspacing="0">
			...
			<?php 
				$no = 0;
				foreach($barangmasuk as $stb) {
					$no++;
				?>
				<tr>
					<td style="padding:5px 5px 5px 5px;font-size:12px;"><?=$no;?></td>
					<td style="padding:5px 5px 5px 5px;font-size:12px;"><?= "{$stb->brg_nama}";?></td>
					<td style="padding:5px 5px 5px 5px;font-size:12px;"><?= "{$stb->prcd_jml}";?></td>
					<td style="padding:5px 5px 5px 5px;font-size:12px;"><?= "{$stb->brg_satuan}";?></td>
					<td style="padding:5px 5px 5px 5px;font-size:12px;"><?= "{$stb->prcd_harga_satuan}";?></td>
					<td style="padding:5px 5px 5px 5px;font-size:12px;"><?= "{$stb->prc_nama}";?></td>
					<td style="padding:5px 5px 5px 5px;font-size:12px;"><?= "{$stb->nama_project}";?></td>
					<td style="padding:5px 5px 5px 5px;font-size:12px;"><?= $stb->nama_project == 7?"Donatur":"Pengajuan";?></td>
