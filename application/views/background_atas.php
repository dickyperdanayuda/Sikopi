...
<head>
  ...
  <link rel="icon" href="<?= base_url("assets/"); ?>files/logokopi.png" type="image/png">
  <!-- Font Awesome Icons -->
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        <img src="<?= base_url("assets"); ?>/files/logokopi.png" alt="Logo" class="brand-image img-circle elevation-3">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?= base_url("LaporanStok/tampil"); ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?= base_url("LaporanBarangKeluar/tampil"); ?>" class="nav-link">
                <i class="nav-icon fas fa-clipboard-list"></i>
                <p>
            ...
            <li class="nav-item">
              <a href="<?= base_url("LaporanBarangMasuk/tampil"); ?>" class="nav-link">
                <i class="nav-icon fas fa-clipboard-list"></i>
                <p>
          ...
          <?php }else if ($this->session->userdata('level') == 2) { ?>
            ...
            <li class="nav-item">
              <a href="<?= base_url("Gudang/tampil"); ?>" class="nav-link">
          ...
          <?php }else if ($this->session->userdata('level') == 3) { ?>
            ...
            <li class="nav-item">
              <a href="<?= base_url("Stok/tampil"); ?>" class="nav-link">
                <i class="nav-icon fas fa-boxes"></i>
                <p>
                  Stok
                </p>
        ...
        <nav class="mt-2 pt-3" style="border-top:1px solid #595959;">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="#" onclick="buka_changelog()" class="nav-link">
